		...
		opts = {
			spec = {
				...
				},
				{
					...
					{ "<A-d>", [[<cmd>Lspsaga term_toggle<CR>]], desc = "Open terminal" },
					{
						"<A-w>",
				...
				--{
				--    -- Expressions
				--    {'j', '<Cmd>v:count == 0 ? "gj" : "j"<CR>', desc = 'Move cursor down' },
				--    {'k', '<Cmd>v:count == 0 ? "gk" : "k"<CR>', desc = 'Move cursor up' },
				--    { mode = 'n', remap = false, silent = true, expr = true }
				--},
				{
